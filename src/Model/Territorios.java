...
public class Territorios 
{
	...
	private void InicializaTerritorios()
	{
		...
		ListaTerritorios.add(new Territorio("Argelia", Continente.Africa,"Nigeria,Egito,Espanha,Italia"));
		ListaTerritorios.get(2).SetDelimitacao(424, 356, 534, 343, 424, 399, 509, 399);
		ListaTerritorios.add(new Territorio("Egito", Continente.Africa,"Somalia,Nigeria,Argelia,Romenia,Jordania"));
		...
		ListaTerritorios.add(new Territorio("Somalia", Continente.Africa, "Angola,Egito,Africa do Sul,Nigeria,Arabia Saudita"));
		...
		ListaTerritorios.add(new Territorio("Groelandia", Continente.AmericaDoNorte, "Calgary,Reino Unido,Quebec"));
		...
		ListaTerritorios.add(new Territorio("Quebec", Continente.AmericaDoNorte,"Vancouver,Nova York,Texas,Groelandia"));
		...
		ListaTerritorios.add(new Territorio("Arabia Saudita", Continente.Asia,"Jordania,Iraque,Somalia"));
		...
		ListaTerritorios.add(new Territorio("Cazaquistao", Continente.Asia, "Russia,China,Turquia,Mongolia,Siberia,Letonia,Japao"));
		...
		ListaTerritorios.add(new Territorio("Coreia do Sul", Continente.Asia,"China,Coreia do Norte,India,Bangladesh,Tailandia"));
		...
		ListaTerritorios.add(new Territorio("Iraque", Continente.Asia,"Ira,Arabia Saudita,Jordania,Siria"));
		...
		ListaTerritorios.add(new Territorio("Jordania", Continente.Asia,"Arabia Saudita,Iraque,Egito,Siria"));
		ListaTerritorios.get(26).SetDelimitacao(608,318,658,318,611,365,642,356);
		ListaTerritorios.add(new Territorio("Letonia", Continente.Asia,"Estonia,Russia,Cazaquistao,Turquia,Ucrania,Polonia,Suecia"));
		...
		ListaTerritorios.add(new Territorio("Siria", Continente.Asia,"Turquia,Paquistao,Iraque,Jordania,Ira"));
		ListaTerritorios.get(32).SetDelimitacao(626,275,708,274,632,301,706,302);
		ListaTerritorios.add(new Territorio("Tailandia", Continente.Asia,"Bangladesh,Coreia do Sul"));
		ListaTerritorios.get(33).SetDelimitacao(884,351,925,351,882,433,918,431);
		ListaTerritorios.add(new Territorio("Turquia", Continente.Asia,"Cazaquistao,Letonia,Siria,Paquistao,China,Ucrania"));
		...
		ListaTerritorios.add(new Territorio("Espanha", Continente.Europa,"Franca,Argelia"));
		ListaTerritorios.get(39).SetDelimitacao(427,263,461,264,423,300,470,304);
		ListaTerritorios.add(new Territorio("Franca", Continente.Europa,"Italia,Espanha,Reino Unido"));
		ListaTerritorios.get(40).SetDelimitacao(462,215,524,218,463,260,463,260);
		ListaTerritorios.add(new Territorio("Italia", Continente.Europa,"Franca,Romenia,Polonia,Argelia"));
		...
		ListaTerritorios.add(new Territorio("Romenia", Continente.Europa,"Italia,Ucrania,Polonia,Egito"));
		ListaTerritorios.get(44).SetDelimitacao(566,237,583,240,563,299,598,294);
		ListaTerritorios.add(new Territorio("Suecia", Continente.Europa,"Franca,Italia,Letonia,Estonia"));
		...
		ListaTerritorios.add(new Territorio("Indonesia", Continente.Oceania,"Perth,Australia,India,Bangladesh"));
		...
		ListaTerritorios.add(new Territorio("Perth", Continente.Oceania,"Australia"));
